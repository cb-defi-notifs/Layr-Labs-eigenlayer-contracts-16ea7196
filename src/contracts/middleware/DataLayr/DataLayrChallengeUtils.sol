        ...
        assembly {
            ...
            if iszero(
                staticcall(
                    ...
                    0x180,
// TODO: @gpsanant this comment conflicted with a comment that said this was pairingInput[12] -- as-is, this refers to pairingInput[11] -- should it be pairingInput[12] ?
