    ...
    // ,DSTest
{
    ...
    function getDataCommitmentAndMultirevealDegreeAndSymbolBreakdownFromHeader(
        // bytes calldata header
        bytes calldata
    ) public pure returns (uint256[2] memory, uint48, uint32, uint32) {
    ...
    function getZeroPolyMerkleRoot(uint256 degree) internal returns(bytes32) {
        ...
        if(log == 0) {
            return 0xa059dfdeb6fc546a13d30cb6c9906fce0f0e0272bdd70281145a9fa6780afdc8;
        } else if(log == 1) {
            return 0x10e0b40abb47ec8e2a5c7ddca2cfb51a70e7432091d8a2a35c1856d3923f1d71;
        } else if(log == 2) {
            return 0xf71bc765bde3e267c636cf5bd3e5a96664f0fe9e01b8d54e4b01afe15014e76c;
        } else if(log == 3) {
            return 0xe8e7782cf9886e6d69dcbc3b7a2f58ced7c06ddb35acf8e5a5d58c887b34874a;
        } else if(log == 4) {
            return 0x0598c3a0c6a1d2ccfd2c93bc96eac392dfe3d0d445c97c46441152943318e63f;
        } else if(log == 5) {
            return 0x41cb97c473072fddba8ed717f8dc7b7e0fd5dc744a8ba2a9e253ad8d78dfa32f;
        } else if(log == 6) {
            return 0x26f7374da50cbfe17ef3cf487f51ea44f555399866ad742ea06462334f4f66b4;
        } else if(log == 7) {
            return 0xbca38bf3ddb80fd127340860bab7f8ae429c34021b7190cc3f7d4713146783ad;
        } else if(log == 8) {
            return 0xf9ebc418bccf0d6a95b8ae266988021be7aa7b724ea59b8f7e0ad5b267e5b946;
        } else if(log == 9) {
            return 0xb0748c026000b13eebd6f09e068bb8bc2222719356dda302885ceea08ca71880;
        } else if(log == 10) {
            return 0xacfd8fb390342be6ef9ccfc6a85d63efe7aedf83ca6c4d57f5b53ebb209f9022;
        } else if(log == 11) {
            return 0x062b58a8cf8d73d7d75d1eabb10c8f578ee9e943478db743fddb03bac8ddcfb4;
        } else {
