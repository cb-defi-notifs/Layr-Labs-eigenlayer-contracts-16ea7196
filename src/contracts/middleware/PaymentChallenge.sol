...
//         sm = IServiceManager(serviceManager);
...
//         IRegistry dlRegistry = IRegistry(address(IRepository(IServiceManager(address(sm)).repository()).registry()));
