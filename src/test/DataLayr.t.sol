...
contract DataLayrTests is DSTest, DataLayrTestHelper {
    ...
    function testInadequateQuorumStake(uint256 ethAmount, uint256 eigenAmount) public {
...

        {
            ...
            _testRegisterOperatorWithDataLayr(0, 3, testEphemeralKey, testSocket);
        }
        ...
        (signerAggSig.sigma0,  signerAggSig.sigma1) = getNonSignerAggSig(1);
        (nonSignerPK1.x, nonSignerPK1.y) = getNonSignerPK(0, 1);
        (nonSignerPK2.x, nonSignerPK2.y) = getNonSignerPK(1, 1);
        (registrantApkG2.apk0, registrantApkG2.apk1, registrantApkG2.apk2, registrantApkG2.apk3) = getAggPubKeyG2WithoutNonSigners(1);
