...
contract DelegationTests is TestHelper {
    ...
    function testForNonSigners(uint256 ethAmount, uint256 eigenAmount) public {
        ...
        signer.sigma0 = uint256(20617740300811009543012419127686924884246271121030353570695308863131407887373);
        signer.sigma1 = uint256(11071552465919207288683976891087172465162060876240494884992829947249670282179);
