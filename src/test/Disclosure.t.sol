...
contract DisclosureDeployer is DSTest {
    ...
    function testCommitToSamePolynomial() public {
        ...
        coors[0] = 14454340801642512897465483173279507241180053951973046131536861267080193565607;
        coors[1] = 7300128489156653597012057502047524010933616474553200909590131210838584218171;
        coors[2] = 1598068943238092412304148656922757962511866396290769884304254861045104315194;
        coors[3] = 2840856310821858817649113726190482393961047895798363457470935309452021117098;
    ...
    function testChallengerCannotRespondNotOnTheirTurn() public {
        ...
        uint256[4] memory coors;
        coors[0] = 1598068943238092412304148656922757962511866396290769884304254861045104315194;
        coors[1] = 2840856310821858817649113726190482393961047895798363457470935309452021117098;
        coors[2] = 1598068943238092412304148656922757962511866396290769884304254861045104315194;
        coors[3] = 2840856310821858817649113726190482393961047895798363457470935309452021117098;
        cheats.expectRevert("Must be challenger and thier turn or operator and their turn");
        dc.challengeCommitmentHalf(true, coors);
    }
    ...
    function testCannotDoOneStepWhenNotTurn() public {
        ...
        cheats.prank(operator);
        uint256[4] memory coors;
        coors[0] = 12623042442131138433218131872348034718530098703302257680506121880219970513239;
        coors[1] = 17063130108049825168764659754731928816245619340444518567222000281866131469355;
        coors[2] = 16021416397311877923351017713527508996348613744360009971459449207531314478848;
        coors[3] = 5867550432962507573704372579384352852364626287621156286726787059052804067882;
        dc.challengeCommitmentHalf(true, coors);
        //respond back
        cheats.prank(challenger);
        ...
        proof[0] = bytes32(0x18c5e5d9db855fc2bfa2ff4fa8bc1f01e813dbfc3c698573a800f230a2554e89);
        proof[1] = bytes32(0x9cd261b77934b80c8e1b2bbb85740d440751bed87f429e629a8c57cc84591994);
        bytes memory poly = new bytes(32);
        for (uint256 i = 0; i < poly.length - 1; i++) {
            poly[i] = 0;
        }
        poly[poly.length - 1] = 0xFF;
        dc.respondToDisclosureChallengeFinal(true, bytes32(0), 1, 2, poly, flags, proof);
    }
